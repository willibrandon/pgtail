...
- Python 3.12 + PowerShell (workflow scripts), XML (manifest), Nuitka, Windows SDK (MakeAppx.exe), Partner Center API (024-windows-store)
- N/A (build artifacts only, no persistence) (024-windows-store)
